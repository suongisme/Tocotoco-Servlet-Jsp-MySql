						...
						<c:forEach var="cart" items="${carts}">
							...
							<div class="items__item">
								...
								<div class="item__action">
									<a class="action__handle action__handle--left" href="${pageContext.request.contextPath}/cart/add?id=${cart.getId()}">+</a>
									<p class="action__quantity">${cart.getQuantity()}</p>
									<a class="action__handle action__handle--right" href="${pageContext.request.contextPath}/cart/subtract?id=${cart.getId()}">-</a>
								</div>
							</div>
						</c:forEach>
					</c:otherwise>
